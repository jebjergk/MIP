...
using (
    ...
    from values
        ...
        ('NEWS_SCORE_CAP', '0.20',
         'Explicit cap used by aggregated-news proposer adjustments'),
        ('NEWS_HOT_PRESSURE', '2.50',
         'Aggregated info_pressure threshold used for HOT weighting in proposer'),
        ('NEWS_CONFLICT_HIGH', '0.60',
         'Conflict threshold for blocking/risk rules in proposer'),
        ('NEWS_SIZE_MULT_CAUTION', '0.75',
         'Position size multiplier when news conflict is elevated'),
        ('NEWS_BLOCK_ON_CONFLICT', 'true',
         'When true, block new entries under HOT + high conflict'),
        ('NEWS_GLOBAL_POLL_MINUTES', '30',
        ...
        ('NEWS_AGG_BADGE_HOT_THRESHOLD', '2.50',
         'Threshold for HOT badge in NEWS_AGGREGATED_EVENTS'),
