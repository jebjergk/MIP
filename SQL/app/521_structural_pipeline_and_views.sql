...
LEFT JOIN MIP.APP.STRUCTURAL_REGIME_TAG rg
  ON rg.SYMBOL = sp.SYMBOL AND rg.AS_OF_DATE = se.SETUP_DATE
LEFT JOIN MIP.APP.STRUCTURAL_PATH_STATS ps
  ON ps.SETUP_FAMILY = sp.SETUP_FAMILY AND ps.MARKET_TYPE = se.MARKET_TYPE AND ps.EVAL_WINDOW = 20
LEFT JOIN MIP.APP.STRUCTURAL_SETUP_TRUST tr
  ON tr.SETUP_FAMILY = sp.SETUP_FAMILY AND tr.MARKET_TYPE = se.MARKET_TYPE AND tr.EVAL_WINDOW = 20
