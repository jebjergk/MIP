-- v_agent_attribution_brief.sql
-- Purpose: Agent-ready portfolio attribution rollups and top movers

use role MIP_ADMIN_ROLE;
use database MIP;

create or replace view MIP.MART.V_AGENT_ATTRIBUTION_BRIEF as
with base as (
    select
        PORTFOLIO_ID,
        RUN_ID,
