...
select
    ...
    median(case when o.EVAL_STATUS = 'SUCCESS' then o.REALIZED_RETURN end) as MEDIAN_RETURN,
    stddev_samp(case when o.EVAL_STATUS = 'SUCCESS' then o.REALIZED_RETURN end) as STDDEV_RETURN,
    min(case when o.EVAL_STATUS = 'SUCCESS' then o.REALIZED_RETURN end) as MIN_RETURN,
    max(case when o.EVAL_STATUS = 'SUCCESS' then o.REALIZED_RETURN end) as MAX_RETURN,
    avg(case
    ...
    corr(case when o.EVAL_STATUS = 'SUCCESS' then r.SCORE end,
         case when o.EVAL_STATUS = 'SUCCESS' then o.REALIZED_RETURN end) as SCORE_RETURN_CORR,
