...
_PATTERN_STRATEGY_GUIDANCE = {
    "MOMENTUM": {
        ...
        "evaluation_guidance": "Favor trades where the trend is clear and volume confirms. Be cautious if the move looks overextended or exhaustion signals are present. Stop-loss should trail below recent support.",
    ...
    "MEAN_REVERSION": {
        ...
        "expected_hold": "Short-term (1-5 bars). Mean-reversion trades target quick snap-backs, not sustained trends.",
        "risk_profile": "The price could continue falling (mean shifts). Size conservatively and use tight stops.",
    },
    "ORB": {
