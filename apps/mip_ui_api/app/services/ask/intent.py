...
_METRIC_CUES = ("metric", "ratio", "drawdown", "confidence", "conviction", "kpi", "this number")
_LINEAGE_CUES = (
    "where does",
    "where is this",
    "which view",
...
def classify_intent(question: str, history: list[dict[str, str]]) -> str:
    ...
    if any(cue in q for cue in _DIAGNOSIS_CUES):
        return "state_diagnosis"
    # Trading / market cues before generic "what is" so e.g. "What is slippage?" routes correctly
