...
| **Decision Console** | A live UI page that shows open daily positions, their real-time decision lifecycle (entry, monitoring, candidate detection, exit triggers), and a rolling event feed with full gate trace audit for each decision. |
