...
**Copy the entire content below (from "## Context for ChatGPT" through the final paragraph) into a new ChatGPT message.** ChatGPT has no access to your repo or any physical files; this text is the only context.
